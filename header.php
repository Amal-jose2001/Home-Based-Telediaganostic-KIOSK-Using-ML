				...
				<div class="container">
					<div class="row">
						<div class="col-md-2 col-sm-12 col-xs-12">
							<!-- Logo -->
							<div class="logo">
								<a href=""><span>M</span>edical</span></a>
							</div>
							<!--/ End Logo -->
						</div>
							...
							<div class="nav-area">
								...
								<nav class="mainmenu">
							        ...
							        ?>
											...
											<li class="<?php echo $current_path === '/medical/user_info.php' ? 'active' : '' ?>"><a href="user_info.php" >User Info</a></li>
							        ...
							        ?>
											...
											<li class="<?php echo $current_path === '/medical/slot.php' ? 'active' : '' ?>"><a href="slot.php" >Slots</a></li>
											<li class="<?php echo $current_path === '/medical/view_result1.php' ? 'active' : '' ?>"><a href="view_result1.php" >Results</a></li>
											<li class="<?php echo $current_path === '/medical/chat2.php' ? 'active' : '' ?>"><a href="chat2.php" >Chat</a></li>
